 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://Test/", wsdlLocation = "http://localhost:8084/myWebServer/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://Test/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/myWebServer/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://Test/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Test/", "NewWebServicePort"), NewWebService.class, features);
    }
